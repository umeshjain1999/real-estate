...
function ProfileForm({
  ...
  const handleChange = (e) => {
    ...
    if ((objProperty === 'phone' || objProperty === 'pincode') && !isNormalNumber(ele.value)) {
      return false
    }
    setUser(prev => {
      return {
      ...
      <form onSubmit={formSubmission} className='profile__form' >
        <div className="profile__form-inner-wrap">
          ...
          <div className="profile__form-input-wrap">
            ...
            <Input value={user?.phone} onChange={handleChange} disabled={disable} required className='profile__form-input' type="tel" name="phone" />
          </div>
          {/* <div className="profile__form-input-wrap">
